...
public class MyServerSocket {
    ...
    private final List<ClientHandler> clientThreads = new ArrayList<>();
    ...
    private void listen() throws Exception {
        ...
        while (true) {
            ...
            ClientHandler handler = new ClientHandler(client, clientAddress, token);
            clientThreads.add(handler);
            System.out.println("Added: " + handler + " to thread list");
            handler.start();
            clientAddress += 1;
        }
    }
                ...
                while ((data = in.readLine()) != null) {
                    ...
                    // READ|jeton_client|nom_fichier|
                        ...
                        try {
                            ...
                            this.join();  // 'this' refers to the current ClientHandler thread
